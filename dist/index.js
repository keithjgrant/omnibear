...
class Micropub {
  ...
  getEndpointsFromUrl(url) {
    return new Promise((fulfill, reject) => {
      ...
      let baseUrl = url;
      // Fetch the given url
      axios__WEBPACK_IMPORTED_MODULE_1___default()({ url, method: 'get', responseType: 'text' })
        .then(res => {
...
var ChangeViewTabs = (_dec = (0, _mobxPreact.inject)('store', 'auth', 'settings'), _dec(_class = (0, _mobxPreact.observer)(_class = function (_Component) {
  ...
  _createClass(ChangeViewTabs, [{
    ...
    key: 'switchTo',
    value: function switchTo(type) {
      var _this2 = this;

      return function () {
        _this2.props.store.setViewType(type);
      };
    }
  }]);
...
var headerViews = [_constants.NOTE, _constants.REPLY, _constants.BOOKMARK, _constants.LIKE, _constants.REPOST];

var Header = (_dec = (0, _mobxPreact.inject)('store'), _dec(_class = (0, _mobxPreact.observer)(_class = function (_Component) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      return (0, _preact.h)(
        ...
        store.viewType === _constants.NOTE ? (0, _preact.h)(
          'h2',
          { className: 'header-title' },
          'New note'
        ) : null,
        this.showUrlSelector() ? (0, _preact.h)(_UrlSelector2.default, null) : null
      );
    }
  }, {
    key: 'showUrlSelector',
    value: function showUrlSelector() {
      ...
      return [_constants.REPLY, _constants.BOOKMARK, _constants.LIKE, _constants.REPOST].includes(store.viewType);
    }
  }]);
...
var LoginForm = (_dec = (0, _mobxPreact.inject)('auth'), _dec(_class = (0, _mobxPreact.observer)(_class = function (_Component) {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                e.preventDefault();
                domain = _this.getNormalizedDomain();

                _this.setState({ domain: domain });
                _context.next = 5;
                return _this.props.auth.login(domain);
  ...
  _createClass(LoginForm, [{
    ...
    value: function render() {
      ...
      return (0, _preact.h)(
        ...
        auth.hasErrors ? (0, _preact.h)(_Message2.default, {
          message: {
            type: _constants.MESSAGE_ERROR,
            message: auth.errorMessage || 'Error'
          }
        }) : null,
        auth.authorizationPageOpened ? (0, _preact.h)(_Message2.default, {
          message: {
            type: _constants.MESSAGE_INFO,
            message: 'Your authorization page has been opened in a new tab. You may close this window and complete your login there.'
          }
        }) : null
      );
    }
...
var _LikeForm = __webpack_require__(/*! ./form/LikeForm */ "./src/components/form/LikeForm.js");
...
var LikeForm = (_dec = (0, _mobxPreact.inject)('store'), _dec(_class = (0, _mobxPreact.observer)(_class = function (_Component) {
  _inherits(LikeForm, _Component);

  function LikeForm() {
    _classCallCheck(this, LikeForm);

    return _possibleConstructorReturn(this, (LikeForm.__proto__ || Object.getPrototypeOf(LikeForm)).apply(this, arguments));
  }
    ...
    value: function render() {
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          'Like ',
          (0, _preact.h)(_Heart2.default, null)
        )
      );
    }
  }]);
    ...
    value: function render() {
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          'Repost ',
          (0, _preact.h)(_Repost2.default, null)
        )
      );
    }
  }]);
...
var _Webmention = __webpack_require__(/*! ../svg/Webmention */ "./src/components/svg/Webmention.js");

var _Webmention2 = _interopRequireDefault(_Webmention);
...
var UrlSelector = (_dec = (0, _mobxPreact.inject)('store'), _dec(_class = (0, _mobxPreact.observer)(_class = function (_Component) {
  ...
  _createClass(UrlSelector, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          supportsWebmention = _state.supportsWebmention;
      var store = this.props.store;

      return (0, _preact.h)(
        'div',
        { className: 'url-selector', onClick: function onClick(e) {
            return e.stopPropagation();
          } },
        supportsWebmention ? (0, _preact.h)(
          'div',
          { className: 'wm-overlay' },
          (0, _preact.h)(_Webmention2.default, { title: 'This page supports webmention' })
        ) : null,
        (0, _preact.h)(
          'h2',
          { className: 'header-title' },
...
var AuthenticationFields = (_dec = (0, _mobxPreact.inject)('auth'), _dec(_class = (0, _mobxPreact.observer)(_class = function (_Component) {
...
var EndpointFields = (_dec = (0, _mobxPreact.inject)('settings'), _dec(_class = (0, _mobxPreact.observer)(_class = function (_Component) {
...
var SettingsForm = (_dec = (0, _mobxPreact.inject)('settings'), _dec(_class = (0, _mobxPreact.observer)(_class = function (_Component) {
...
/***/ "./src/components/svg/Webmention.js":
/*!******************************************!*\
  !*** ./src/components/svg/Webmention.js ***!
  \******************************************/
/*! no static exports found */
...
var Logs = function (_Component) {
  ...
  _createClass(Logs, [{
    ...
    value: function render() {
      ...
      return (0, _preact.h)(
        "svg",
        { className: "svg-logs", viewBox: "0 0 360 360" },
        (0, _preact.h)(
          "desc",
          null,
          "Webmention logo"
        ...
        (0, _preact.h)("path", {
          d: "M207.54,328.99l-42.141-128.841h-0.699L123.263,328.99h-55.36L2.092,80.214h54.668l39.345,169.338h0.695l43.181-128.845 h51.189l42.479,130.927h0.698l30.36-130.841l-39.546-0.086l81.975-76.192l50.864,76.29l-40.281-0.025l-55.872,208.21H207.54z",
          fill: "currentColor"
        })
      );
    }
...
var stores = {
  ...
  auth: _authStore2.default,
  draft: _draftStore2.default,
  settings: _settingsStore2.default
};
...
var AuthStore = (_class = function () {
  function AuthStore() {
    ...
    _initDefineProp(this, 'hasErrors', _descriptor5, this);

    _initDefineProp(this, 'errorMessage', _descriptor6, this);

    _initDefineProp(this, 'authorizationPageOpened', _descriptor7, this);

    _initDefineProp(this, 'loadSettings', _descriptor8, this);

    _initDefineProp(this, 'setDomain', _descriptor9, this);

    _initDefineProp(this, 'setToken', _descriptor10, this);

    _initDefineProp(this, 'setMicropubEndpoint', _descriptor11, this);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 6;
                _context.next = 9;
                return _micropub2.default.getAuthUrl();
              ...
              case 9:
                ...
                (0, _mobx.runInAction)(function () {
                  _this.authorizationPageOpened = true;
                });
                _context.next = 19;
                break;
              ...
              case 15:
                ...
                (0, _log.error)(_context.t0.message, (0, _utils.sanitizeMicropubError)(_context.t0));
                (0, _mobx.runInAction)(function () {
                  _this.hasErrors = true;
                  _this.authorizationPageOpened = false;
                  _this.errorMessage = 'Missing micropub data on ' + domain + '. Please ensure the following links are present: authorization_endpoint, token_endpoint, micropub';
...
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, 'hasErrors', [_mobx.observable], {
  enumerable: true,
  initializer: function initializer() {
    return false;
  }
}), _descriptor6 = _applyDecoratedDescriptor(_class.prototype, 'errorMessage', [_mobx.observable], {
  enumerable: true,
  initializer: function initializer() {
    return '';
  }
}), _descriptor7 = _applyDecoratedDescriptor(_class.prototype, 'authorizationPageOpened', [_mobx.observable], {
  enumerable: true,
  initializer: function initializer() {
    return false;
  }
}), _descriptor8 = _applyDecoratedDescriptor(_class.prototype, 'loadSettings', [_mobx.action], {
  enumerable: true,
  initializer: function initializer() {
    var _this2 = this;

    return function () {
      _this2.domain = localStorage.getItem('domain');
      _this2.token = localStorage.getItem('token');
      _this2.micropubEndpoint = localStorage.getItem('micropubEndpoint');
    };
  }
}), _descriptor9 = _applyDecoratedDescriptor(_class.prototype, 'setDomain', [_mobx.action], {
  enumerable: true,
  initializer: function initializer() {
    var _this3 = this;

    return function (domain) {
      _this3.domain = domain.trim();
      _micropub2.default.options.me = _this3.domain;
      localStorage.setItem('domain', _this3.domain);
    };
  }
}), _descriptor10 = _applyDecoratedDescriptor(_class.prototype, 'setToken', [_mobx.action], {
  enumerable: true,
  initializer: function initializer() {
    var _this4 = this;

    return function (token) {
      _this4.token = token.trim();
      _micropub2.default.options.token = _this4.token;
      localStorage.setItem('token', _this4.token);
    };
  }
}), _descriptor11 = _applyDecoratedDescriptor(_class.prototype, 'setMicropubEndpoint', [_mobx.action], {
  enumerable: true,
  initializer: function initializer() {
    var _this5 = this;

    return function (url) {
      _this5.micropubEndpoint = url.trim();
      _micropub2.default.options.micropubEndpoint = _this5.micropubEndpoint;
      localStorage.setItem('micropubEndpoint', _this5.micropubEndpoint);
    };
  }
}), _applyDecoratedDescriptor(_class.prototype, 'login', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'login'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'clearCredentials', [_mobx.action], Object.getOwnPropertyDescriptor(_class.prototype, 'clearCredentials'), _class.prototype)), _class);
exports.default = new AuthStore();

/***/ }),

/***/ "./src/stores/draftStore.js":
/*!**********************************!*\
  !*** ./src/stores/draftStore.js ***!
  \**********************************/
/*! no static exports found */
...
var DraftStore = (_class = function () {
  function DraftStore() {
...
var SettingsStore = (_class = function () {
  function SettingsStore() {
    ...
    _initDefineProp(this, 'addReacji', _descriptor13, this);

    _initDefineProp(this, 'setSlugFieldName', _descriptor14, this);

    _initDefineProp(this, 'setSyndicateToFieldName', _descriptor15, this);
...
}), _descriptor13 = _applyDecoratedDescriptor(_class.prototype, 'addReacji', [_mobx.action], {
  enumerable: true,
  initializer: function initializer() {
    var _this7 = this;

    return function (value) {
      _this7.reacji.push(value.substr(0, MAX_LENGTH));
    };
  }
}), _descriptor14 = _applyDecoratedDescriptor(_class.prototype, 'setSlugFieldName', [_mobx.action], {
  enumerable: true,
  initializer: function initializer() {
    var _this8 = this;

    return function (name) {
      _this8.slugFieldName = name;
      _this8.save();
    };
  }
}), _descriptor15 = _applyDecoratedDescriptor(_class.prototype, 'setSyndicateToFieldName', [_mobx.action], {
  enumerable: true,
  initializer: function initializer() {
    var _this9 = this;

    return function (name) {
      _this9.syndicateToFieldName = name;
      _this9.save();
    };
  }
...
var Store = (_class = function () {
  function Store() {
    ...
    _initDefineProp(this, 'currentPageUrl', _descriptor2, this);
  ...
  _createClass(Store, [{
    ...
    value: function _flashErrorMessage(message, err) {
      (0, _log.error)(message, (0, _utils.sanitizeMicropubError)(err));
      this.flashMessage = {
        message: message,
        type: _constants.MESSAGE_ERROR,
        err: err
  ...
  return Store;
}(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'viewType', [_mobx.observable], {
  enumerable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, 'currentPageUrl', [_mobx.observable], {
  enumerable: true,
  initializer: null
